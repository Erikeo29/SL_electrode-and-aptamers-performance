### Analyse des résultats — étude 1 : paramètres d'électrode
...
- **Contamination** : effet linéaire et proportionnel. À 30 % de sites bloqués, le courant de pic est réduit d'environ un tiers, conformément à la réduction de $\Gamma_{eff}$.

- **Cuivre exposé** : effet mesurable mais nettement secondaire par rapport au nickel à pH 7.4 (tampon PBS). Le cuivre contribue faiblement au courant de fond.
